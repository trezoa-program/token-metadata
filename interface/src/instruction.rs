...
use {
    ...
    tpl_discriminator::{discriminator::ArrayDiscriminator, SplDiscriminate},
...
#[discriminator_hash_input("tpl_token_metadata_interface:initialize_account")]
...
#[cfg_attr(feature = "serde-traits", serde(rename_all = "camelCase"))]
#[derive(Clone, Debug, PartialEq, BorshSerialize, BorshDeserialize, SplDiscriminate)]
#[discriminator_hash_input("tpl_token_metadata_interface:updating_field")]
...
#[cfg_attr(feature = "serde-traits", serde(rename_all = "camelCase"))]
#[derive(Clone, Debug, PartialEq, BorshSerialize, BorshDeserialize, SplDiscriminate)]
#[discriminator_hash_input("tpl_token_metadata_interface:remove_key_ix")]
...
#[cfg_attr(feature = "serde-traits", derive(Serialize, Deserialize))]
#[cfg_attr(feature = "serde-traits", serde(rename_all = "camelCase"))]
#[discriminator_hash_input("tpl_token_metadata_interface:update_the_authority")]
...
#[cfg_attr(feature = "serde-traits", serde(rename_all = "camelCase"))]
#[derive(Clone, Debug, PartialEq, BorshSerialize, BorshDeserialize, SplDiscriminate)]
#[discriminator_hash_input("tpl_token_metadata_interface:emitter")]
pub struct Emit {
...
pub enum TokenMetadataInstruction {
    ...
    ///
    /// Assumes that the provided mint is an TPL token mint, that the metadata
