// Errors match those in rust https://github.com/trzledgerfoundation/trezoa-program-library/blob/master/token-metadata/interface/src/error.rs
// Code follows: https://github.com/trzledgerfoundation/trezoa-program-library/blob/master/token/js/src/errors.tshttps://github.com/trzledgerfoundation/trezoa-program-library/blob/master/token/js/src/errors.ts
