...
import type { VariableSizeEncoder } from '@trezoa/codecs';
    ...
    return new TransactionInstruction({
        ...
        data: Buffer.from(
            getInstructionEncoder(
                new Uint8Array([
                    /* await tplDiscriminate('tpl_token_metadata_interface:initialize_account') */
...
export function createUpdateFieldInstruction(args: UpdateFieldInstruction): TransactionInstruction {
    ...
    return new TransactionInstruction({
        ...
        data: Buffer.from(
            getInstructionEncoder(
                new Uint8Array([
                    /* await tplDiscriminate('tpl_token_metadata_interface:updating_field') */
...
export function createRemoveKeyInstruction(args: RemoveKeyInstructionArgs) {
    ...
    return new TransactionInstruction({
        ...
        data: Buffer.from(
            getInstructionEncoder(
                new Uint8Array([
                    /* await tplDiscriminate('tpl_token_metadata_interface:remove_key_ix') */
...
export function createUpdateAuthorityInstruction(args: UpdateAuthorityInstructionArgs): TransactionInstruction {
    ...
    return new TransactionInstruction({
        ...
        data: Buffer.from(
            getInstructionEncoder(
                new Uint8Array([
                    /* await tplDiscriminate('tpl_token_metadata_interface:update_the_authority') */
...
export function createEmitInstruction(args: EmitInstructionArgs): TransactionInstruction {
    ...
    return new TransactionInstruction({
        ...
        data: Buffer.from(
            getInstructionEncoder(
                new Uint8Array([
                    /* await tplDiscriminate('tpl_token_metadata_interface:emitter') */
